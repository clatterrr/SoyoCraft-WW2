...
public class SunFlowerRenderer extends GeoEntityRenderer<SunFlowerEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(SunFlowerEntity instance) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/sun_flower.png");
    }

    @Override
    public RenderType getRenderType(SunFlowerEntity animatable, float partialTicks, PoseStack stack,
