...
public class DuckRenderer extends GeoEntityRenderer<DuckEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(DuckEntity instance) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/duck.png");
    }

    @Override
    public RenderType getRenderType(DuckEntity animatable, float partialTicks, PoseStack stack,
