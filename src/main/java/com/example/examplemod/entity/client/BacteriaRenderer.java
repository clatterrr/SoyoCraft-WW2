...
public class BacteriaRenderer extends GeoEntityRenderer<BacteriaEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(BacteriaEntity instance) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/bacteria.png");
    }

    @Override
    public RenderType getRenderType(BacteriaEntity animatable, float partialTicks, PoseStack stack,
