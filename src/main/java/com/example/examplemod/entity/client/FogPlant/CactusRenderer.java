...
import com.example.examplemod.entity.custom.FogPlant.CactusEntity;
...
public class CactusRenderer extends GeoEntityRenderer<CactusEntity> {
    public CactusRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new CactusModel());
    }

    @Override
    public ResourceLocation getTextureLocation(CactusEntity p_114482_) {
