...
public class PotatoMineRenderer extends GeoEntityRenderer<PotatoMineEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(PotatoMineEntity instance) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/potato_mine.png");
    }

    @Override
    public RenderType getRenderType(PotatoMineEntity animatable, float partialTicks, PoseStack stack,
