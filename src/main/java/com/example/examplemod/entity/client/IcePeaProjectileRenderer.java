...
public class IcePeaProjectileRenderer extends EntityRenderer<IcePeaProjectileEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ExampleMod.MODID, "textures/entity/magic_projectile.png");
    protected IcePeaProjectileModel model;

    public IcePeaProjectileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new IcePeaProjectileModel(pContext.bakeLayer(ModModelLayers.ICE_PEA_PROJECTILE_LAYER));
        this.shadowRadius = 0.5f;
    }

    public void render(IcePeaProjectileEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(IcePeaProjectileEntity pEntity) {
        return TEXTURE;
    }
}