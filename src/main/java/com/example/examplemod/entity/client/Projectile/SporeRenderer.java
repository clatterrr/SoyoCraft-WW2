...
public class SporeRenderer extends GeoEntityRenderer<SporeEntity> {
    public SporeRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new SporeModel());
    }

    @Override
    public ResourceLocation getTextureLocation(SporeEntity p_114482_) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/spore.png");
    }

    @Override
    public RenderType getRenderType(SporeEntity animatable, float partialTicks, PoseStack stack,
