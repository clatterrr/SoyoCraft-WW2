...
public class SunRenderer extends EntityRenderer<SunEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ExampleMod.MODID, "textures/entity/sun.png");
    protected SunModel model;

    public SunRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new SunModel(pContext.bakeLayer(ModModelLayers.SUN_LAYER));
        this.shadowRadius = 0.5f;
    }

    public void render(SunEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(SunEntity p_114482_) {
        return TEXTURE;
    }
}