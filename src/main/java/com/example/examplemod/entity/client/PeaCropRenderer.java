...
public class PeaCropRenderer extends EntityRenderer<PeaCropEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ExampleMod.MODID, "textures/entity/pea_crop.png");
    protected PeaCropModel model;

    public PeaCropRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new PeaCropModel(pContext.bakeLayer(ModModelLayers.SUN_LAYER));
        this.shadowRadius = 0.5f;
    }

    public void render(PeaCropEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(PeaCropEntity p_114482_) {
        return TEXTURE;
    }
}