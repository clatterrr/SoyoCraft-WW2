...
public class SunShroomRenderer extends GeoEntityRenderer<SunShroomEntity> {
    public SunShroomRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new SunShroomModel());
    }

    @Override
    public ResourceLocation getTextureLocation(SunShroomEntity p_114482_) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/sun_shroom.png");
    }

    @Override
    public RenderType getRenderType(SunShroomEntity animatable, float partialTicks, PoseStack stack,
