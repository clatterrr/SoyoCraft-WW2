...
public class MariGoldRenderer extends GeoEntityRenderer<MariGoldEntity> {
    public MariGoldRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new MariGoldModel());
    }

    @Override
    public ResourceLocation getTextureLocation(MariGoldEntity p_114482_) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/marigold.png");
    }

    @Override
    public RenderType getRenderType(MariGoldEntity animatable, float partialTicks, PoseStack stack,
