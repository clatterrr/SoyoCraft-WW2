...
public class ConeRenderer extends EntityRenderer<ConeEntity> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ExampleMod.MODID, "textures/entity/cone.png");
    protected ConeModel model;

    public ConeRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        model = new ConeModel(pContext.bakeLayer(ModModelLayers.CONE_LAYER));
        this.shadowRadius = 0.5f;
    }

    public void render(ConeEntity entity, float pEntityYaw, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(ConeEntity p_114482_) {
        return TEXTURE;
    }
}