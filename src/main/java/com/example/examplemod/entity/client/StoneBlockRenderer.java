...
public class StoneBlockRenderer extends GeoEntityRenderer<StoneBlockEntity> {
    public StoneBlockRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new StoneBlockModel());
    }

    @Override
    public ResourceLocation getTextureLocation(StoneBlockEntity p_114482_) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/stone_block.png");
    }

    @Override
    public RenderType getRenderType(StoneBlockEntity animatable, float partialTicks, PoseStack stack,
