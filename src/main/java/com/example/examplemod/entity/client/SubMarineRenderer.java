...
import com.example.examplemod.entity.custom.SubmarineEntity;
...
public class SubMarineRenderer extends GeoEntityRenderer<SubmarineEntity> {
    ...
    @Override
    public RenderType getRenderType(SubmarineEntity animatable, float partialTicks, PoseStack stack,
