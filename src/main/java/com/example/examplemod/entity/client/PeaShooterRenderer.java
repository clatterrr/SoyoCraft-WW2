...
public class PeaShooterRenderer extends GeoEntityRenderer<PeaShooterEntity> {
    public PeaShooterRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_, new PeaShooterModel());
    }

    @Override
    public ResourceLocation getTextureLocation(PeaShooterEntity p_114482_) {
        return new ResourceLocation(ExampleMod.MODID, "textures/entity/pea_shooter.png");
    }

    @Override
    public RenderType getRenderType(PeaShooterEntity animatable, float partialTicks, PoseStack stack,
