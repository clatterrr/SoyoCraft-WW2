...
public class SunShroomEntity extends ThePlantEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public SunShroomEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SummonGoal extends Goal {
        private final SunShroomEntity cactus;

        public SummonGoal() {
            cactus = SunShroomEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    SunShroomEntity c = new SunShroomEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
