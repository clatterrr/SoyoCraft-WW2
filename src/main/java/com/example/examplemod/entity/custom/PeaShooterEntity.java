...
public class PeaShooterEntity extends Monster implements IAnimatable {
    ...
    public class SummonGoal extends Goal {
        private final PeaShooterEntity cactus;

        public SummonGoal() {
            cactus = PeaShooterEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    PeaShooterEntity c = new PeaShooterEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
