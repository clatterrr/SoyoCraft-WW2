...
public class ScreenDoorZombieEntity extends TheZombieEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public ScreenDoorZombieEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SummonGoal extends Goal {
        private final ScreenDoorZombieEntity cactus;

        public SummonGoal() {
            cactus = ScreenDoorZombieEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    ScreenDoorZombieEntity c = new ScreenDoorZombieEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
