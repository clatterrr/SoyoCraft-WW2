...
public class FlagZombieEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public FlagZombieEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        */
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.flag_zombie.attack", true));
        return PlayState.CONTINUE;
    }
    ...
    public class SummonGoal extends Goal {
        private final FlagZombieEntity cactus;

        public SummonGoal() {
            cactus = FlagZombieEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    FlagZombieEntity c = new FlagZombieEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
