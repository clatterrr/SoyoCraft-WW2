...
public class SmokerEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public SmokerEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SimilerGoal extends Goal {
        private final SmokerEntity smiler;
        public SimilerGoal(){
            smiler = SmokerEntity.this;
        }
        ...
        public void tick(){
            final LivingEntity target = smiler.getTarget();
            if (target != null && target.isAlive()) {
                smiler.getNavigation().moveTo(target, 10f);
            }
            /*
