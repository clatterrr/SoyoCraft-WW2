...
public class FootballZombieEntity extends TheZombieEntity implements IAnimatable {
    ...
    public class SummonGoal extends Goal {
        private final FootballZombieEntity cactus;

        public SummonGoal() {
            cactus = FootballZombieEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    FootballZombieEntity c = new FootballZombieEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
