...
public class LilyPadEntity extends ThePlantEntity implements IAnimatable {

    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(LilyPadEntity.class, EntityDataSerializers.BOOLEAN);
    private AnimationFactory factory = new AnimationFactory(this);

    private BlockPos originPos;

    public LilyPadEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.lily_pad.idle2", true));
    ...
    public class ShootGoal extends Goal {
        private final LilyPadEntity shroom;

        public ShootGoal() {
            shroom = LilyPadEntity.this;
        }
