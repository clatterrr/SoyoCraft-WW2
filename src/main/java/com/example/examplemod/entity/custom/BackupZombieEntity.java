...
public class BackupZombieEntity extends TheZombieEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public BackupZombieEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SummonGoal extends Goal {
        private final BackupZombieEntity cactus;

        public SummonGoal() {
            cactus = BackupZombieEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    BackupZombieEntity c = new BackupZombieEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
