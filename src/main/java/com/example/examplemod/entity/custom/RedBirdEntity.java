...
public class RedBirdEntity extends TheBirdEntity implements IAnimatable {
    ...
    public RedBirdEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public void tick(){
        ...
        if(this.cool_down < 20){
            this.setDeltaMovement(0, 0.1f, -0.4f);
        }else{
        ...
        */
        ...
        if(this.level.getBlockState(bp).getBlock() == Blocks.STONE){
            this.kill();
        }
