...
public class VillagerSkinStealerEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public VillagerSkinStealerEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
...
if(event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.skin_stealer.walk", true));
        }else {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.skin_stealer.idle", true));
        }
    ...
    public class ThrowGoal extends Goal {
        private final VillagerSkinStealerEntity me;

        public ThrowGoal() {
            this.me = VillagerSkinStealerEntity.this;
        }
