...
public class CreeperSkinStealerEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public CreeperSkinStealerEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
...
if(event.isMoving()) {
    ...
    public class ThrowGoal extends Goal {
        private final CreeperSkinStealerEntity me;

        public ThrowGoal() {
            this.me = CreeperSkinStealerEntity.this;
        }
