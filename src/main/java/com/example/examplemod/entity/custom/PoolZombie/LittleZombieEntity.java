...
public class LittleZombieEntity extends TheZombieEntity implements IAnimatable {

    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(LittleZombieEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> STYLE =
            SynchedEntityData.defineId(LittleZombieEntity.class, EntityDataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);

    public LittleZombieEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public void tick() {
        ...
        if(this.getHealth() < 3 && this.drop_hand == false){
            this.drop_hand = true;
