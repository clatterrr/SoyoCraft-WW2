...
public class RepeaterEntity extends Monster implements IAnimatable {
    ...
    public class SummonGoal extends Goal {
        private final RepeaterEntity cactus;

        public SummonGoal() {
            cactus = RepeaterEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    RepeaterEntity c = new RepeaterEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
    ...
    public class ShootGoal extends Goal {
        private final RepeaterEntity shooter;

        public ShootGoal() {
            shooter = RepeaterEntity.this;
        }
