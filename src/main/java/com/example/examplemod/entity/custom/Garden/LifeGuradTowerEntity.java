...
public class LifeGuradTowerEntity extends Monster implements IAnimatable {
    ...
    public LifeGuradTowerEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
