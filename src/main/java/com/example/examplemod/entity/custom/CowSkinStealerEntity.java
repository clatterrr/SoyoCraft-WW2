...
public class CowSkinStealerEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public CowSkinStealerEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
...
if(event.isMoving()) {
    ...
    public class ThrowGoal extends Goal {
        private final CowSkinStealerEntity me;

        public ThrowGoal() {
            this.me = CowSkinStealerEntity.this;
        }
