...
public class DoomShroomEntity extends ThePlantEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public DoomShroomEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SummonGoal extends Goal {
        private final DoomShroomEntity cactus;

        public SummonGoal() {
            cactus = DoomShroomEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    DoomShroomEntity c = new DoomShroomEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
