...
public class SeaShroomEntity extends ThePlantEntity implements IAnimatable {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(SeaShroomEntity.class, EntityDataSerializers.BOOLEAN);
