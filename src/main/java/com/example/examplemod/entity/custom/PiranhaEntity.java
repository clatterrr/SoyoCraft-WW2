...
public class PiranhaEntity extends Monster implements IAnimatable {
    ...
    public PiranhaEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public void tick() {
        ...
        if(this.cool >= 200){
          this.cool = 0;
            ...
            this.setDeltaMovement(0, 0.1f, 0f);
        }else if(this.cool < 100){
            this.setDeltaMovement(0, 0.0f, 0f);
        }else if(this.cool < 120){
            this.setDeltaMovement(0,-0.1f, 0.0f);
        }else{
