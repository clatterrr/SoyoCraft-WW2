...
public class BacteriaEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public BacteriaEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if(event.isMoving()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.back.walk", true));
        }else {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.back.idle", true));
        }
    ...
    public class ThrowGoal extends Goal {
        private final BacteriaEntity me;

        public ThrowGoal() {
            this.me = BacteriaEntity.this;
        }
