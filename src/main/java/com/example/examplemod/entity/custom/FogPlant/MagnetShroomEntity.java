...
public class MagnetShroomEntity extends ThePlantEntity implements IAnimatable {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(MagnetShroomEntity.class, EntityDataSerializers.BOOLEAN);
    private AnimationFactory factory = new AnimationFactory(this);

    public MagnetShroomEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
