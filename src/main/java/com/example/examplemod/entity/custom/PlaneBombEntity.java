...
public class PlaneBombEntity extends Projectile {
	private static final EntityDataAccessor<Boolean> HIT =
			SynchedEntityData.defineId(PlaneBombEntity.class, EntityDataSerializers.BOOLEAN);
	private int counter = 0;

	public PlaneBombEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
		super(pEntityType, pLevel);
	}

	public PlaneBombEntity(Level pLevel, Player player) {
		super(ModEntityTypes.PLANE_BOMB.get(), pLevel);
		setOwner(player);
	...
	public PlaneBombEntity(Level pLevel, Entity entity) {
		super(ModEntityTypes.PLANE_BOMB.get(), pLevel);
		setOwner(entity);
