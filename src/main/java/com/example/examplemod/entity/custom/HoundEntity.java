...
public class HoundEntity extends Monster implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public HoundEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
...
if(event.isMoving()) {
    ...
    public class ThrowGoal extends Goal {
        private final HoundEntity me;

        public ThrowGoal() {
            this.me = HoundEntity.this;
        }
