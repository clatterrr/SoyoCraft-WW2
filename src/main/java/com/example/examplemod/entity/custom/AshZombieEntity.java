...
public class AshZombieEntity extends TheZombieEntity implements IAnimatable {
    ...
    private static final EntityDataAccessor<Integer> STYLE =
            SynchedEntityData.defineId(AshZombieEntity.class, EntityDataSerializers.INT);
    private AnimationFactory factory = new AnimationFactory(this);

    public AshZombieEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.ash_zombie.idle", true));
