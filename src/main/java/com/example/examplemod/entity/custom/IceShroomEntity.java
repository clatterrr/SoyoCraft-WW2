...
public class IceShroomEntity extends ThePlantEntity implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public IceShroomEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public class SummonGoal extends Goal {
        private final IceShroomEntity cactus;

        public SummonGoal() {
            cactus = IceShroomEntity.this;
        ...
        public void tick() {
            ...
            if (this.cactuspos != this.cactus.getOnPos()) {
                if (this.cool_down > 5) {
                    ...
                    IceShroomEntity c = new IceShroomEntity((EntityType<? extends Monster>) this.cactus.getType(), this.cactus.getLevel());
